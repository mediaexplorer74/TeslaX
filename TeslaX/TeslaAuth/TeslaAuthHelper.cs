...
namespace TeslaAuth
{
    ...
    {
        // paste your own app's client_id and client_secret here
        const string TESLA_CLIENT_ID = 
            "81527cff06843c8634fdc09e8ac0abefb46ac849f38fe1e431c2ef2106796384";

        const string TESLA_CLIENT_SECRET = 
        ...
        static string ComputeSHA256Hash(string text)
        {
            ...
            {
                var hash = sha256.ComputeHash(Encoding.UTF8.GetBytes(text));//(Encoding.Default.GetBytes(text));
